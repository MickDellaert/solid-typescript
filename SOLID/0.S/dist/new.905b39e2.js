...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"MusicPlayer.ts":[function(require,module,exports) {
"use strict";
...
},{}],"Car.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function Car(MAXIMUM_FUEL_CAPACITY, engine) {
    this._fuel = 0;
    this._miles = 0;
...
var car = new Car_1.Car(100, engine);
...
},{"./MusicPlayer":"MusicPlayer.ts","./Engine":"Engine.ts","./Car":"Car.ts"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "60153" + '/');
